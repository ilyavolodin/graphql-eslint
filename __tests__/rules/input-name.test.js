...
const rule = require('../../src/rules/input-name');

const eslintTester = new RuleTester({
    parser: require.resolve('../../src/parser')
});

eslintTester.run('input-name', rule, {
    valid: [{
    ...
    invalid: [{
        ...
        options: [{ checkInputType: true }],
        errors: [{ message: 'Input "message" should be called "input"' }, { message: 'InputType "String" name should be "SetMessageInput"' }]
    }, {
